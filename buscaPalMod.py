...
TARGET_URL = "https://eminus.uv.mx/eminus4/page/course/activity/delivery"  # Cambia por el sitio a escanear
with open("aencontrar.txt", "r") as archivo:# Cambia la palabra a buscar
    palabras = [palabra.strip() for palabra in archivo]

print(palabras)

for WORD_TO_SEARCH in palabras:
